...
(function (global, factory) {
  ...
  var Router = function () {
    ...
    babelHelpers.createClass(Router, [{
      ...
      value: function on(regex, handler) {
        if (regex && typeof regex === 'string') this.dispatch(regex, handler);else if (regex && isObject(regex)) this.dispatchAll(regex, handler);else throw new Error('Bad arguments.');
      }
  ...
  function isObject(arg) {
    return typeof Object.prototype.toString.apply(arg).slice(8, -1) === 'Object';
  }
